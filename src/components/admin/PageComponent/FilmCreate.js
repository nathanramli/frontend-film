                ...
                <Card>
                  ...
                  <form onSubmit={this.handleSubmit.bind(this)}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12}>
                        <TextField label="Kode" margin="normal" onChange={this.handleChangesKode.bind(this)} fullWidth placeholder="Contoh: naruto-sub-indo (Samarkan sedikit kata-katanya)" helperText="Jangan gunakan spasi (Ini untuk urlnya nanti)(Samarkan kata-katanya. Contoh: nartos-sub-indo" required/>
                      </Grid>
                      <Grid item xs={12}>
                      ...
                      <Grid item xs={12}>
                        <TextField label={this.state.jenis === "m" ? "Pengarang" : "Musim Rilis"} margin="normal" onChange={this.handleChangesMusimRilis.bind(this)} placeholder={this.state.jenis === "m" ? "Contoh: Makoto Shinkai" : "Contoh: Spring 2019"} fullWidth required/>
                      </Grid>
                      <Grid item xs={12}>
